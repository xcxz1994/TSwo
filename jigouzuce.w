...
<div xmlns="http://www.w3.org/1999/xhtml" xid="window" class="window" component="$UI/system/components/justep/window/window"
  design="device:m;">  
  <div component="$UI/system/components/justep/model/model" xid="model" style="height:auto;left:75px;top:9px;"></div>  
      ...
      <div component="$UI/system/components/justep/titleBar/titleBar" class="x-titlebar"
        ...
        <div class="x-titlebar-left" xid="div1"> 
          <a component="$UI/system/components/justep/button/button" class="btn btn-link btn-only-icon"
            xid="button1" icon="icon-chevron-left"> 
    ...
    <div class="x-panel-content" xid="content1"> 
      <div component="$UI/system/components/justep/controlGroup/controlGroup"
        ...
        <input component="$UI/system/components/justep/input/input" class="form-control"
          xid="jigouname" placeHolder="用户名" style="font-size:16px;"/>
        <div xid="div5" class="borde"/>  
        <input component="$UI/system/components/justep/input/input" class="form-control"
          xid="password" placeHolder="6-12位字母数字组合密码" style="font-size:16px;"/>
        <div xid="div6" class="borde"/>  
        <input component="$UI/system/components/justep/input/input" class="form-control"
          xid="repassword" placeHolder="确认密码" style="font-size:16px;" onBlur="repasswordBlur"/>
        <div xid="div6" class="borde"/>  
        <div component="$UI/system/components/justep/row/row" class="x-row yanzheng"
          ...
          <div class="x-col x-col-fixed" xid="col1" style="width:auto;"> 
            <a component="$UI/system/components/justep/button/button" class="btn btn-link"
              label="+86&gt;" xid="button2" style="font-size:16px;"> 
              <i xid="i2"/>  
          ...
          <div class="x-col x-col-fixed" xid="col3" style="width:auto;"> 
            <a component="$UI/system/components/justep/button/button" class="btn btn-link"
              xid="button4" style="font-size:16px;" label="获取验证码"> 
              <i xid="i4"/>  
        ...
        <a component="$UI/system/components/justep/button/button" class="btn btn-default"
          label="注册" xid="regBtn" style="font-size:20px;width:100%;margin-top:60px;" onClick="regBtnClick"> 
          <i xid="i5"/>  
...
<span component="$UI/system/components/justep/windowDialog/windowDialog" xid="windowDialog1" src="$UI/TSwo/jigoulogin.w"></span></div>